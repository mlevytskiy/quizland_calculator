...
enum ButtonArea1 {
  ...
  static List<ButtonArea1> getAllInRightPosition(bool isOneAndNineInRightPosition) {
    if (isOneAndNineInRightPosition) {
      return ButtonArea1.values;
    } else {
      List<ButtonArea1> result = List.of(ButtonArea1.values);
      result.swap(n9.index, n1.index);
      return result;
    }
  }
}
